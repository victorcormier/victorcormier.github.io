                    ...
                    if (pp_type == 'image') {
                        ...
                        correctSizes = _fitToViewport(movie_width, movie_height);
												if (pp_type == 'brightcove') {
													...
													playerID = grab_param('playerID', images[setPosition]);
        ...
        _showContent = function() {
            ...
            $pp_pic_holder.animate({
                ...
                if (pp_type != 'image') $pp_pic_holder.find('#pp_full_res')[0].innerHTML = pp_typeMarkup;
								if (pp_type == 'brightcove') BCL.addPlayer($pp_pic_holder.find('#pp_full_res')[0], pp_typeMarkup, movie_width, movie_height, playerID);
